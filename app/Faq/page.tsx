    ...
    const faqs = [
        {
            ...
            paras: ['Determining your life insurance needs depends on various factors like your income, debts, and future expenses.',
        ...
        },
        {
            ...
            paras: ['At our agency, ensuring you get the best rates is our priority.',
        ...
        {
            question: 'How long does it take to get approved for life insurance coverage?',
            paras: ['The approval process for life insurance coverage typically ranges from a few days to several weeks.',
        ...
        {
            question: 'What happens if I outlive the term of my life insurance policy?',
            paras: ['If you outlive the term of your life insurance policy, there are several options available.',
        ...
        {
            question: 'How can I ensure my life insurance policy adequately protects my loved ones?',
            paras: ['To ensure your life insurance adequately protects your loved ones, start by assessing your family\'s financial needs and future obligations.',
