...
export default function Footerpage() {
  return (
    ...
    //       height={108}
    //     />
    //     <span className={styles.mobilefoot}>
    //       <Image src={"/mobilefoot.svg"} alt="logo" height={40} width={190} />
    //     </span>
    //     <span className={styles.footerline}></span>

    //     <p>
    //       Welcome to <span className={styles.inline}>SKY FINANCIAL</span>, where
    //       we prioritize protecting your future above all else. Our About Us
    //       section offers a glimpse into who we are, our values, and why
    //       we&apos;re dedicated to ensuring your peace of mind. Meet our
    ...
    //       ones&apos; financial security. At [Agency Name], we&apos;re here to
    //       guide you toward a future of confidence and security.
    //     </p>
